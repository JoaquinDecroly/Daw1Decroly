...
public class SQLAccessBase {
    public List<String> getProductos(String producto) {
    ...
    public List<String> getProductoByReferencia(String ref) {
        List<String> productos = new LinkedList<String>();
    ...
    public List<String> getProductoByTipo(int tipe) {
        List<String> productos = new LinkedList<String>();
    ...
    public List<String> getProductoByCantidad(int cant) {
        List<String> productos = new LinkedList<String>();
    ...
    public void deleteProductoByReferencia(String referencia) {
