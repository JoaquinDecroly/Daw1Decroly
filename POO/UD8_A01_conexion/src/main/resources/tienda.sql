...
CREATE TABLE tipo (
    ...
    -- Comentario: 'id' es la clave primaria de la tabla, se incrementa automicamente con cada nuevo registro.
...
-- We will insert the type name in a temporal column, and then we will get the id
...
-- We will add a temporal column with the name of the type, and then we will get the id
INSERT INTO productos (referencia, nombre, descripcion, tipo, cantidad, precio, descuento, iva, aplicarDto)
SELECT
