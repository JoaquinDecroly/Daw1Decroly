...
SELECT
    ...
    -- Generar una descripcileatoria: 'Descripción del producto ' seguido de un número entre 0 y 99.
    CONCAT('Descripción del producto ', CAST(FLOOR(RAND() * 100) AS CHAR)),
    -- Generar un tipo aleatorio: un número entre 1 y 10 (correspondiente a los tipos en la tabla 'tipo').
    FLOOR(RAND() * 10) + 1,
...
-- Limitar el número de filas insertadas a 100.
LIMIT 100;
