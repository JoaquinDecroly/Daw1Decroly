...
public boolean canta;
    ...
    public Canario(String nombre, int edad, Estado estado, LocalDate fechaNacimiento, LocalDate fechaMuerte, boolean vuela, boolean pico, Color color, boolean canta) {
