        ...
        int opcion;
         try(Scanner scanner = new Scanner(System.in)){ 
            ...
            scanner.nextLine(); // Limpiar el buffer
                switch (opcion) {
                    case 1:
                    mostrarProductos(); // Llama al método para mostrar productos
                    break;
                case 2:
                    eliminarProducto(scanner); // Llama al método para eliminar producto
                    break;
                case 3:
                    guardarInventario(); // Llama al método para guardar el inventario
                    System.out.println("Inventario guardado. Saliendo...");
                    break;
                case 4:
                    registrarProducto(scanner); // Llama al método para registrar producto
                    break;
                    case 0:
